...
public final class LogHelper {
	...
	private static String parseLog(String logStr) {
		...
		if(logStr.contains(requestTag)) { 
			//请求log 格式形如�?8-23 03:05:43.112 I/Renren-SDK-Request(  775): 
			...
			//添加method�?			sb.append(log.substring(methodIndex, methodEnd)).append("\r\n").append("request:\r\n");
			...
			//响应log 格式形如�?3:05:51.452 I/Renren-SDK-Response(  775): 
			...
			//添加参数 key=value �?			paramStr.replace(",", ",\r\n");
